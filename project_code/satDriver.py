...
class motorInterface():
    def __init__(self, observer = None, satellite=None):
        ...
        self.azDegPerStep = 0      # 1:5 ratio
        self.elevDegPerStep = 0     # 1:2 ratio
        ...
        while not self.stopMotorsThread:
            if self.keepHoming:
                ...
                if not self.azHomed or not self.elevHomed:
                    ...
                    if not GPIO.input(elev_limit_pin) and self.elevHomed: # OPS is not interrupted and allows current flow
